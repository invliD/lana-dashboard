...
urlpatterns = [
	...
	url(r'^autonomous-systems/(?P<as_number>\d+)/$', views.show_autonomous_system, name='autonomous_system-details'),
	url(r'^autonomous-systems/(?P<as_number>\d+)/delete$', views.delete_autonomous_system, name='autonomous_system-delete'),
	url(r'^autonomous-systems/(?P<as_number>\d+)/edit$', views.edit_autonomous_system, name='autonomous_system-edit'),
